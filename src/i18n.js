  ...
  en: {
    translation: {
      ...
      "scan": {
        ...
        "phrases": [
          "[SYS_OP] Initiating source code structure decryption...",
          "[MODULE] Building Abstract Syntax Tree (AST)... 0x8FA4",
          "[ENGINE] Scanning memory injection & SQL Payload...",
          "[MEM_CHK] Analyzing Cross-Site Scripting anomalies...",
          "[SEC_OPS] Investigating Hardcoded Secrets & Tokens...",
          "[KERNEL] Pattern matching with Aegis ThreatDB...",
          "[SYS_OP] Finalizing security matrix..."
        ],
        "sysInit": "[SYS_INIT] Allocating scanner memory...",
        "sysInitScan": "[SYS_INIT] Scanning directory...",
        "netTxSetup": "[NET_TX] Setting up Network Transmission...",
        "netTxUpload": "[NET_TX] Uploading Data...",
  ...
  es: {
    translation: {
      ...
      "scan": {
        ...
        "phrases": [
          "[SYS_OP] Iniciando descifrado de estructura de código fuente...",
          "[MODULE] Construyendo Árbol de Sintaxis Abstracta (AST)... 0x8FA4",
          "[ENGINE] Escaneando inyección de memoria y Payload SQL...",
          "[MEM_CHK] Analizando anomalías de Cross-Site Scripting...",
          "[SEC_OPS] Investigando secretos y tokens codificados...",
          "[KERNEL] Coincidencia de patrones con Aegis ThreatDB...",
          "[SYS_OP] Finalizando matriz de seguridad..."
        ],
        "sysInit": "[SYS_INIT] Asignando memoria del escáner...",
        "sysInitScan": "[SYS_INIT] Escaneando directorio...",
        "netTxSetup": "[NET_TX] Configurando Transmisión de Red...",
        "netTxUpload": "[NET_TX] Subiendo Datos...",
  ...
  id: {
    translation: {
      ...
      "scan": {
        ...
        "sysInit": "[SYS_INIT] Mengalokasikan memori pemindai...",
        "sysInitScan": "[SYS_INIT] Memindai direktori...",
        "netTxSetup": "[NET_TX] Menyiapkan Transmisi Jaringan...",
        "netTxUpload": "[NET_TX] Mengunggah Data...",
  ...
  ja: {
    translation: {
      ...
      "scan": {
        ...
        "phrases": [
          "[SYS_OP] ソースコード構造の復号化を開始しています...",
          "[MODULE] 抽象構文木 (AST) を構築中... 0x8FA4",
          "[ENGINE] メモリインジェクションと SQL ペイロードをスキャン中...",
          "[MEM_CHK] クロスサイトスクリプティングの異常を分析中...",
          "[SEC_OPS] ハードコードされたシークレットとトークンを調査中...",
          "[KERNEL] Aegis ThreatDB とのパターンマッチング...",
          "[SYS_OP] セキュリティマトリックスを完成させています..."
        ],
        "sysInit": "[SYS_INIT] スキャナメモリを割り当て中...",
        "sysInitScan": "[SYS_INIT] ディレクトリをスキャン中...",
        "netTxSetup": "[NET_TX] ネットワーク転送をセットアップ中...",
        "netTxUpload": "[NET_TX] データをアップロード中...",
